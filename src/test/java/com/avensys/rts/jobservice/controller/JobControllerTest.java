...
public class JobControllerTest {
	...
	void setUp() {
		...
		jobRequest = new JobRequest(1L, "Java Developer", 1L, 1L, "form date", false, 1L, 1L);
	...
	void testCreateJobPositive() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/job/add")
				.content(asJsonString(new JobRequest(1L, "Java Developer", 1L, 1L, "form date", false, 1L, 1L)))
