...
public class JobCandidateStageControllerTest {
	...
	void setUp() {
		...
		jobCandidateStageEntity1 = new JobCandidateStageEntity(2L, jobEntity, jobStageEntity, "Active", candidateEntity,
				1L, 1L, jobSubmissionData);
		jobCandidateStageRequest = new JobCandidateStageRequest(1L, 1L, 1L, "Active", 1L, 1L, 1L, "full time",
				"form data", 1L, 1L);
		jobCandidateStageRequest1 = new JobCandidateStageRequest(2L, 1L, 1L, "Active", 1L, 1L, 1L, "part time",
				"form data", 1L, 1L);
